...
ARDDIR 				= /Applications/Arduino.app/Contents/Resources/Java
...
#AVRDUDE = avrdude
AVRDUDE = $(ARDDIR)/hardware/tools/avr/bin/avrdude -B 40 -C $(ARDDIR)/hardware/tools/avr/etc/avrdude.conf
